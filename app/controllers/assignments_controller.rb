class AssignmentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @assignment.save
        ...
        Notification.create(title: "New Assignment Added - #{@assignment.title} created", url: "/assignments/#{@assignment.id}")
      else
  ...
  private
    ...
    def assignment_params
      params.require(:assignment).permit(:title, :body, :url, :user_id, :source , :tag_list, :company_list, :approved, :points)
    end
end
