...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post solutions_url, params: { solution: { assignment_id: @solution.assignment_id, body: @solution.body, language: @solution.language, user_id: @solution.user_id } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { assignment_id: @solution.assignment_id, body: @solution.body, language: @solution.language, user_id: @solution.user_id } }
