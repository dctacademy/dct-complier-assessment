...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post practices_url, params: { practice: { assignment_group_id: @practice.assignment_group_id, assignment_id: @practice.assignment_id } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { assignment_group_id: @practice.assignment_group_id, assignment_id: @practice.assignment_id } }
